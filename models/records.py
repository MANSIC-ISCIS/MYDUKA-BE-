...
class Record(db.Model):
    ...
    clerk_id = db.Column(db.Integer,db.ForeignKey("clerk.clerk_id"),nullable=False)
    ...
    admin_id = db.Column(db.String(50), db.ForeignKey("store_admin.admin_id"),nullable=False)
